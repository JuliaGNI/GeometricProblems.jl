...
const LODE_PROBLEMS = (
    ...
    ("LotkaVolterra2d.ldaeproblem_slrk", lv2.ldaeproblem_slrk(),
        2, false, ([2.0, 1.0], [0.3, -0.2])),
    ("LotkaVolterra2dGauge.lodeproblem", lv2gauge.lodeproblem(),
        2, false, ([2.0, 1.0], [0.3, -0.2])),
    ("LotkaVolterra2dSingular.lodeproblem",
        lv2sing.lodeproblem(), 2, false, ([2.0, 1.0], [0.3, -0.2])),
    ("LotkaVolterra2dSymmetric.lodeproblem",
        lv2symm.lodeproblem(), 2, false, ([2.0, 1.0], [0.3, -0.2])),
    ("LotkaVolterra4d.lodeproblem", lv4.lodeproblem(), 4,
        false, ([2.0, 1.0, 1.0, 1.0], [0.3, -0.2, 0.1, 0.4])),
    ("LotkaVolterra4d.ldaeproblem", lv4.ldaeproblem(), 4,
        false, ([2.0, 1.0, 1.0, 1.0], [0.3, -0.2, 0.1, 0.4])),
    ("LotkaVolterra4d.ldaeproblem_secondary", lv4.ldaeproblem_secondary(),
        4, false, ([2.0, 1.0, 1.0, 1.0], [0.3, -0.2, 0.1, 0.4])),
    ("MasslessChargedParticle.lodeproblem",
        mcp.lodeproblem(), 2, false, ([1.3, 0.2], [0.7, -0.4])),
    ("MasslessChargedParticle.ldaeproblem",
        mcp.ldaeproblem(), 2, false, ([1.3, 0.2], [0.7, -0.4])),
    ("MasslessChargedParticleSingular.lodeproblem",
        mcps.lodeproblem(), 2, false, ([1.3, 0.2], [0.7, -0.4])),
    ("MasslessChargedParticleSingular.ldaeproblem",
        mcps.ldaeproblem(), 2, false, ([1.3, 0.2], [0.7, -0.4])),
    ("PointVortices.lodeproblem_formal_lagrangian", pv.lodeproblem_formal_lagrangian(),
        4, false, ([0.2, 0.4, 0.4, 0.2], [0.1, -0.1, 0.2, 0.3])),
    ("PointVorticesLinear.lodeproblem_formal_lagrangian",
        pvl.lodeproblem_formal_lagrangian(), 4, false,
        ([0.3, 0.0, -0.6, 0.1], [0.1, -0.1, 0.2, 0.3])),
