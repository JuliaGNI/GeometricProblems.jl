...
_timestep(timespan::Tuple, n_time_steps::Integer) = (timespan[2] - timespan[1]) /
                                                    (n_time_steps-1)
...
_check_components(N, x::AbstractArray{<:Number}, name) = @assert length(x) == N + 2 "$name has $(length(x)) components, expected N + 2 = $(N + 2)"
...
"""
function hodeproblem(N::Int = Ñ, q₀ = compute_initial_condition2(μ̃, N + 2).q,
        p₀ = compute_initial_condition2(μ̃, N + 2).p;
        timespan = DEFAULT_TIMESPAN,
        timestep = DEFAULT_TIMESTEP,
        parameters = default_parameters(),
...
vectors of samples.
"""
function hodeensemble(N::Int = Ñ, q₀ = compute_initial_condition2(μ̃, N + 2).q,
        p₀ = compute_initial_condition2(μ̃, N + 2).p;
        timespan = DEFAULT_TIMESPAN,
        timestep = DEFAULT_TIMESTEP,
        parameters = default_parameters(),
...
"""
function lodeproblem(N::Int = Ñ, q₀ = compute_initial_condition2(μ̃, N + 2).q,
        p₀ = compute_initial_condition2(μ̃, N + 2).p;
        timespan = DEFAULT_TIMESPAN,
        timestep = DEFAULT_TIMESTEP,
        parameters = default_parameters(),
...
vectors of samples.
"""
function lodeensemble(N::Int = Ñ, q₀ = compute_initial_condition2(μ̃, N + 2).q,
        p₀ = compute_initial_condition2(μ̃, N + 2).p;
        timespan = DEFAULT_TIMESPAN,
        timestep = DEFAULT_TIMESTEP,
        parameters = default_parameters(),
