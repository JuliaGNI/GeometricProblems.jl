...
function lotka_volterra_2d_hode(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
function lotka_volterra_2d_iode(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
function lotka_volterra_2d_pode(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
function lotka_volterra_2d_lode(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
function lotka_volterra_2d_hdae(q₀=q₀, p₀=ϑ(0, q₀), λ₀=zero(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
function lotka_volterra_2d_idae(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀), λ₀=zero(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
"Creates an implicit DAE object for the Lotka-Volterra 2D model."
function lotka_volterra_2d_idae_spark(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀), λ₀=zero(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
function lotka_volterra_2d_pdae(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀), λ₀=zero(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
function lotka_volterra_2d_ldae(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀), λ₀=zero(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
function lotka_volterra_2d_slrk(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀), λ₀=zero(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
...
function lotka_volterra_2d_dg(q₀=q₀, p₀=lotka_volterra_2d_pᵢ(q₀); tspan=tspan, tstep=Δt, parameters=default_parameters)
