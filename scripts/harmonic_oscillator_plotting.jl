#!/usr/bin/env julia
#
# Harmonic Oscillator Plotting Module
# Provides visualization functions for the harmonic oscillator using CairoMakie
# This module can be loaded separately from the main GeometricProblems.jl package
# to avoid dependency conflicts.

module HarmonicOscillatorPlotting

using CairoMakie

export plot_spring, plot_spring_animation, plot_harmonic_oscillator
export xpos, ypos, zpos, ϑ, spring
...
end  # module HarmonicOscillatorPlotting
