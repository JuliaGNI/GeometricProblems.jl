...
Plot the `x₁`–`x₂` phase-space portrait of a 2D Lotka-Volterra solution. Returns
a Makie `Figure`.
...
"""
function LotkaVolterra2d.plot_phase_portrait(sol, equ; nplot = 1, nt = :auto, latex = true)
...
Plot the `x₁`–`x₂` phase-space portrait of a 2D Lotka-Volterra solution next to
its relative energy error. Returns a Makie `Figure`.
"""
...
Plot the time traces `x₁(t)`, `x₂(t)` of a 2D Lotka-Volterra solution together
